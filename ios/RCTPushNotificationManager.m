...
{
  NSString *jsonString = [notification valueForKeyPath:@"data"];
  
  /* Sqlite Database Saving */
  EGODatabase *db = [EGODatabase databaseWithPath:[NSHomeDirectory() stringByAppendingPathComponent:@"Library/LocalDatabase/PUSH.db"]];
  [db executeQuery:@"CREATE TABLE IF NOT EXISTS PUSH_MESSAGES (CONTENT TEXT)" ];
  [db executeQuery:@"INSERT INTO PUSH_MESSAGES VALUES(?)" parameters:@[(NSString *) jsonString]];
  /* Sqlite Database Saving */
